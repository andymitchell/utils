...
function testObjectsAndArrays(cloneFunc:typeof cloneDeepScalarValues) {
    describe('cloneDeepScalarValues for objects and arrays', () => {
...
testObjectsAndArrays(cloneDeepScalarValues);
testObjectsAndArrays(cloneDeepScalarValuesAny as typeof cloneDeepScalarValues);